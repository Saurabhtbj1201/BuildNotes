    ...
    <footer className='bg-gray-800 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            ...
            <p className='mt-2 text-sm'>Greater Noida, Uttar Pradesh, India</p>
            <p className='text-sm'>Email: Support@buildnotes.com</p>
            <p className='text-sm'>Phone: +91 9798024301</p>
        </div>
      ...
      <div className='mt-4 border-t border-gray-700 pt-6 text-center text-sm'>
        ...
        <p className='mt-2'>Designed & developed by <a href='https://www.linkedin.com/in/saurabhtbj1201' target='_blank' rel='noopener noreferrer' className='text-red-400 hover:text-red-300 underline'>Saurabh Kumar</a></p>
      </div>
    </footer>
  )
}
